...
// mot de pass comprenant entre 4 et 8 carractères, et contenant obligatoirement au moins 1 chiffre.
...
module.exports = {
    register: function(req, res) {
        ...
        if (username.length >= 13 || username.length <= 3) {
            return res.status(400).json({ 'error': 'wrong username (must be length 3 - 13)' });
        }
